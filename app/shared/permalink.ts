/**
 * Permalink — pluggable post URL structure. Single source of truth for the
 * frontend (blog SSR + admin SPA); the Bun API builders in backend/ are
 * timezone-aware over flat SQL rows and stay separate on purpose, but MUST
 * keep the same token vocabulary as the parser below.
 *
